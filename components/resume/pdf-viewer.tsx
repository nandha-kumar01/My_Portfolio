...
export default function PDFViewer() {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      {!isMobile && (
        <div className="mt-6 mb-6 py-4 flex flex-row gap-3 space-x-4 px-4 sm:px-0">
          <a
            href={resumePath}
            download
            className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full hover:shadow-lg transition-all duration-300 flex items-center justify-center text-sm sm:text-base min-w-[140px] sm:min-w-[160px]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 sm:px-8 py-3 sm:py-4 bg-neutral-800 hover:bg-neutral-700 rounded-full transition-all duration-300 flex items-center justify-center text-sm sm:text-base min-w-[140px] sm:min-w-[160px]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 sm:h-5 sm:w-5 mr-1.5 sm:mr-2"
